...
This is a Quarto template that assists you in creating a letter on Monash University letterhead. There are two versions of the template, one using LaTeX (`letter-pdf`), and one using Typst (`letter-typst`). The latter is faster to render.
